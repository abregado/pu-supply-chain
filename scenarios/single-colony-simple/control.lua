...
local make_planet_force = function(name,resource_list)
  ...
  for recipe_name, recipe_lua in pairs(planet_force.recipes) do
    if recipe_lua.name == 'pb1' or
            recipe_lua.name == 'pb2' or
            recipe_lua.name == 'pb3' or
            recipe_lua.name == 'pb4' or
            recipe_lua.name == 'pb5' or
            recipe_lua.name == 'ext' or
            recipe_lua.name == 'rig' or
            recipe_lua.name == 'col' or
            recipe_lua.name == 'sto' then
      recipe_lua.enabled = true
    else
...
local on_player_created = function(event)
  ...
  player.set_quick_bar_slot(14,'pb1')
  player.set_quick_bar_slot(15,'pb2')
  player.set_quick_bar_slot(16,'pb3')
  player.set_quick_bar_slot(17,'pb4')
  player.set_quick_bar_slot(18,'pb5')
