...
local on_game_created_from_scenario = function()
  ...
  market.add_npc_supplier('mcg',50,36, false)
  market.add_sell_order('mcg',1000,nil,nil,false)
  market.add_sell_order('bbh',100,nil,nil,false)
  market.add_sell_order('bde',30,nil,nil,false)
  market.add_sell_order('bse',100,nil,nil,false)
  market.add_sell_order('bta',30,nil,nil,false)
end
