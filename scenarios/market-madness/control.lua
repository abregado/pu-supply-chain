...
local on_game_created_from_scenario = function()
  ...
  market.add_npc_supplier('dw',500,75)
  market.add_npc_customer('dw',500,31)
  market.add_npc_supplier('rat',500,102)
  market.add_npc_customer('rat',500,51)
  market.add_npc_supplier('bbh',10,2400)
  market.add_npc_supplier('bde',10,2350)
  market.add_npc_supplier('bta',10,1600)
  market.add_npc_supplier('bse',10,1550)
  market.add_npc_supplier('mcg',500,36)
end
